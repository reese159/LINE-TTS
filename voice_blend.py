...
def blending(voice_list, weight_list, text_to_narrate = ""):
    ...
    :voice_list: List of voice tensors or names to blend.
    :weight_list: List of weights corresponding to each voice tensor.
    :text_to_narrate: Text to narrate using the blended voice.
    :return: A tuple containing the voice generator and the blended voice tensor.
    """
...
def blending_pt_files(voice_tensor_list, weight_list, text_to_narrate = ""):
    ...
    :voice_tensor_list: List of voice tensors to blend.
    :weight_list: List of weights corresponding to each voice tensor.
    :text_to_narrate: Text to narrate using the blended voice.
    :return: A tuple containing the voice generator and the blended voice tensor.
    """
    ...
    try:
        ...
        # Blend voices using the provided weights
        # zip multiplies each voice tensor by its corresponding weight,then we take the sum
