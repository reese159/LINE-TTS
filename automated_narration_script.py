...
# input text
test_txt = file_reader.read_pdf(r"docs/Project Spec.pdf")  # Example text to narrate

cleaned_string = test_txt.replace("\n", " ")

print(cleaned_string)

new_voice = voice_blend.blending(voice_list, weight_list, cleaned_string)
